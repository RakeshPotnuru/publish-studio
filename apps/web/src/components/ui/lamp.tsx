  ...
  return (
    ...
    >
      ...
      <div className="relative isolate z-0 mt-10 flex w-full flex-1 scale-y-125 items-center justify-center sm:mt-0">
        ...
        <div className="absolute inset-auto z-50 h-14 w-[6rem] -translate-y-1/2 rounded-full bg-red-500 opacity-50 blur-3xl sm:h-36 sm:w-[28rem]"></div>
        <motion.div
          initial={{ width: "8rem" }}
      ...
      <div className="relative z-50 -mb-12 flex -translate-y-80 flex-col items-center px-5 sm:-mb-0">
        {children}
      </div>
    </div>
  );
