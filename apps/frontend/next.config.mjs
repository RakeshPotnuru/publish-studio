const cspHeader = `
default-src 'self';
connect-src 'self' ${process.env.NEXT_PUBLIC_CORE_URL} ${process.env.NEXT_PUBLIC_R2_BUCKET_URL} https://sockjs-ap2.pusher.com wss://ws-ap2.pusher.com https://accounts.google.com https://images.unsplash.com https://images.pexels.com https://ik.imagekit.io;
